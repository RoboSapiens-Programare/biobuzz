...
public class PinpointTuner extends Procedure {
    ...
    public void run() throws InterruptedException {
        ...
        if (podType.get() == PodType.CUSTOM) {
            ...
            customPodScalar =
                    OptionalDouble.of(runOpMode(new PinpointCustomPodScalar(distance.get(), pinpointName.get())));
        }
        ...
        List<Double> offsets = runOpMode(new PinpointOffsets(
                pinpointName.get(), podType.get(), customPodScalar, forwardPodReversed, strafePodReversed));
